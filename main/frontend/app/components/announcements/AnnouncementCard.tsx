            ...
            <div className="flex-1 min-w-0">
              ...
              {announcement.pet && (
                <p className="text-sm text-gray-600 mb-2">
                  {announcement.pet.species} {announcement.pet.breed && `• ${announcement.pet.breed}`}
                  {announcement.pet.gender && ` • ${announcement.pet.gender === 'male' ? 'Самец' : 'Самка'}`}
                </p>
              )}
          ...
          <div className="mt-4 pt-3 border-t border-gray-200 flex items-center justify-between text-xs text-gray-500">
            ...
            {announcement.posts && announcement.posts.length > 0 && (
              <span className="flex items-center gap-1">
                📝 {announcement.posts.length} {announcement.posts.length === 1 ? 'публикация' : 'публикаций'}
              </span>
            )}
          </div>
        </div>
